...
<body>
	...
	<section>
		<div class="wrapper">
			...
			<div class="container col s12" style="margin: 30px auto">
			...
			<div class="center">
				<button type="submit" class="waves-effect waves-light btn z-depth-2" style="background-color: #aaa; margin: 20px;">Submit</button>
